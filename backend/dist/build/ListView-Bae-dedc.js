import{j as e,m as y,R as p,fD as O,a as F,T as x,I as $,g_ as Ce,r as R,g$ as L,d as U,h0 as Te,ae as we,h1 as ve,cn as Q,aa as ee,bs as W,h2 as ke,h3 as te,h4 as $e,c8 as De,ck as Me,h5 as Re,bK as Se,aT as Ae,gm as ne,N as P,d$ as Fe,a2 as Ie,E as Ee,h6 as Le,bP as Oe,b1 as z,h7 as Ne,L as oe}from"./strapi-DBLEJUct.js";import{u as D,g as m,C as J,a as H,A as Ue,S as Pe,c as X,b as ie,K as Be}from"./index-JQuKIq68.js";import{d as Ve,e as Y,D as ze,f as Ze,a as We,S as He,v as Ke,s as _e,K as Ge,P as qe,c as Je,C as Xe}from"./sortable.esm-BA0rnzDe.js";import"./index-B3lVezJy.js";import"./groupBy-B89BDu5B.js";import"./_baseEach-C1l9Lgaz.js";import"./sortBy-DFgCfisA.js";import"./_baseMap-CjXFl0Sb.js";import"./index-DhlHN2yz.js";import"./index-BRVyLNfZ.js";const Ye=t=>{let{transform:n}=t;return{...n,x:0}},Qe=y(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,rt=({component:t,dzName:n,index:o,isActive:s=!1,isInDevelopmentMode:a=!1,onClick:l,forTarget:i,targetUid:c,disabled:f})=>{const{components:b,removeComponentFromDynamicZone:k}=D(),r=O(b,t),{icon:d,displayName:u}=r?.info||{},T=w=>{w.stopPropagation(),k({forTarget:i,targetUid:c,dzName:n,componentToRemoveIndex:o})};return e.jsxs(st,{alignItems:"center",direction:"column",className:s?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,onClick:l,role:"tab",tabIndex:s?0:-1,cursor:"pointer","aria-selected":s,"aria-controls":`dz-${n}-panel-${o}`,id:`dz-${n}-tab-${o}`,children:[e.jsx(it,{icon:d,isActive:s}),e.jsx(p,{marginTop:1,maxWidth:"100%",children:e.jsx($,{variant:"pi",fontWeight:"bold",ellipsis:!0,children:u})}),a&&!f&&e.jsx(ae,{cursor:"pointer",tag:"button",onClick:T,children:e.jsx(Ce,{})})]})},at=y(L)`
  width: 3.2rem;
  height: 3.2rem;
  padding: 0.9rem;
...
`,Tt=R.memo(({disabled:t,type:n})=>{const{formatMessage:o}=F(),s=Ie(),a=bt(n),l=o({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),i=()=>{if(t)return!1;const b=jt(n);return s(b),!1},{isLoading:c,allowedActions:f}=Ee(a);return c||!f.canConfigureView&&!f.canConfigureLayout?null:e.jsx(Ct,{startIcon:e.jsx(Le,{}),variant:"tertiary",onClick:i,disabled:t,children:l})}),wt=y(oe.Header)`
  ...
  white-space: nowrap;
`,Et=()=>{const{isInDevelopmentMode:t,contentTypes:n,components:o,isLoading:s}=D(),{formatMessage:a}=F(),{trackUsage:l}=ie(),{contentTypeUid:i,componentUid:c}=Oe(),{onOpenModalAddComponentsToDZ:f,onOpenModalAddField:b,onOpenModalEditSchema:k}=H(),r=i?n[i]:c?o[c]:null;if(s)return null;if(!r){const j=Object.values(n).filter(C=>C.visible===!0&&!C.plugin).map(C=>C.uid).sort();return j.length>0?e.jsx(z,{to:`/plugins/content-type-builder/content-types/${j[0]}`}):e.jsx(z,{to:"/plugins/content-type-builder/content-types/create-content-type"})}if(i&&r.modelType==="contentType"&&r.visible===!1)return e.jsx(z,{to:"/plugins/content-type-builder/content-types/create-content-type",replace:!0});const d="plugin"in r&&r?.plugin!==void 0,u=i?"contentType":"component",T=r?.info?.displayName??"",w=t&&!d,S=j=>{f({dynamicZoneTarget:j,targetUid:r.uid})},M=()=>{if("kind"in r){r?.kind==="collectionType"&&l("willEditNameOfContentType"),r?.kind==="singleType"&&l("willEditNameOfSingleType"),k({modalType:u,forTarget:u,targetUid:r.uid,kind:r?.kind});return}k({modalType:u,forTarget:u,targetUid:r.uid})},I=a({id:m("table.button.no-fields"),defaultMessage:"Add new field"}),A=a({id:m("button.attributes.add.another"),defaultMessage:"Add another field"}),g=r.status==="REMOVED",h=t&&e.jsxs(x,{gap:2,children:[e.jsx(Tt,{type:r,disabled:r.status==="NEW"||g},"link-to-cm-settings-view"),e.jsx(P,{startIcon:e.jsx(te,{}),variant:"tertiary",onClick:M,disabled:!w||g,children:a({id:"app.utils.edit",defaultMessage:"Edit"})}),e.jsx(P,{startIcon:e.jsx(L,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{b({forTarget:u,targetUid:r.uid})},disabled:g,children:r.attributes.length===0?I:A})]});return e.jsxs(e.Fragment,{children:[e.jsx(ne.contentTypeBuilder.Introduction,{children:e.jsx(p,{})}),g&&e.jsx(x,{background:"danger100",justifyContent:"center",padding:4,children:e.jsxs(x,{gap:2,children:[e.jsx(Ne,{fill:"danger600",height:"2rem",width:"2rem"}),e.jsx($,{children:a({id:m("table.warning.deleted"),defaultMessage:"This {kind} has been deleted"},{kind:r.modelType==="contentType"?"Content Type":"Component"})})]})}),e.jsx(wt,{id:"title",primaryAction:h,title:W(T)}),e.jsx(oe.Content,{children:e.jsx(p,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,overflow:"auto",borderColor:"neutral150",children:e.jsx(ue,{type:r,addComponentToDZ:S,isMain:!0})})})]})};export{Et as default};
