         ...
         >
            ...
            >
               <div
                  ...
                  className="overflow-hidden flex size-full flex-col bg-sidebar group-data-[variant=floating]:rounded-3xl group-data-[variant=floating]:border-r group-data-[variant=floating]:shadow-none group-data-[variant=floating]:border-sidebar-border/50"
               >
                  {children}
               </div>
            </div>
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
   return (
      <div
         ...
         data-sidebar="header"
         className={cn(
            "flex flex-col gap-2 p-4 border-b-sidebar-border/50",
            className,
         )}
         {...props}
      />
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
   return (
      <div
         ...
         data-sidebar="footer"
         className={cn(
            "flex flex-col gap-2 p-4 border-t-sidebar-border/50",
            className,
         )}
         {...props}
      />
...
function SidebarSeparator({
   ...
   return (
      <Separator
         ...
         className={cn("mx-2 w-auto bg-foreground", className)}
         {...props}
      />
   );
}
...
const sidebarMenuButtonVariants = cva(
   "peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg p-2 text-left text-sm ring-sidebar-ring outline-hidden hover:cursor-pointer transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
   {
      variants: {
         variant: {
            default:
...
function SidebarMenuSkeleton({
   ...
   return (
      <div
         ...
         className={cn("flex h-8 items-center gap-2 p-4 rounded-lg", className)}
         {...props}
      >
         {showIcon && (
            <Skeleton
