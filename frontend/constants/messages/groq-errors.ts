export const GROQ_ERROR_MESSAGES = {
   ...
   413: "El contenido es demasiado grande para generar este resumen.",
   422: "El servicio de IA no pudo procesar la solicitud.",
   424: "El servicio de IA no pudo completar una dependencia requerida.",
   429: "El servicio de IA está temporalmente limitado. Intentá nuevamente más tarde.",
...
export const GROQ_DEFAULT_ERROR_MESSAGE =
   "No se pudo generar el resumen. Intentá nuevamente.";
